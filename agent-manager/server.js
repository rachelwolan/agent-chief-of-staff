...
app.get('/api/agents', async (req, res) => {
    try {
        const agentsDir = join(dirname(__dirname), 'agents');
...
app.get('/api/output/:filename', async (req, res) => {
    try {
        ...
        const possiblePaths = [
            join(dirname(__dirname), filename),
            join(dirname(__dirname), 'logs', filename),
            join(dirname(__dirname), 'outputs', filename)
        ];
...
app.post('/api/learn-it-all/generate', async (req, res) => {
    try {
        ...
        const dossiersDir = join(dirname(__dirname), 'logs', 'dossiers');
...
app.get('/api/index-card/:date', async (req, res) => {
    try {
        ...
        const cardPath = join(dirname(__dirname), 'logs', 'index-cards', `${date}.json`);
...
app.post('/api/index-card', async (req, res) => {
    try {
        const card = req.body;
        const cardsDir = join(dirname(__dirname), 'logs', 'index-cards');
